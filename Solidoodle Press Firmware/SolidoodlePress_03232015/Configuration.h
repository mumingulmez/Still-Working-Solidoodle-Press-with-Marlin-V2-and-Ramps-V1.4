...
#define CUSTOM_MACHINE_NAME "Futurk Printer"
...
//#define MAGNETIC_PARKING_EXTRUDER
  ...
  //#define MANUAL_SOLENOID_CONTROL                   // Manual control of docking solenoids with M380 S / M381
    ...
    #define MPE_FAST_SPEED      1200      // (mm/min) Speed for travel before last distance point
    #define MPE_SLOW_SPEED       500      // (mm/min) Speed for last distance travel to park and couple
...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_X_POS          { 215, 0 }  // (mm) X positions for parking the extruders
    ...
    //#define PRIME_BEFORE_REMOVE                       // Prime the nozzle before release from the dock
      ...
      #define SWITCHING_TOOLHEAD_PRIME_FEEDRATE    120  // (mm/min) Extruder prime feedrate
      #define SWITCHING_TOOLHEAD_RETRACT_FEEDRATE 1200  // (mm/min) Extruder retract feedrate
    #endif
...
#define TOUCH_MI_PROBE
  ...
  #define TOUCH_MI_RETRACT_Z 20                  // Height at which the probe retracts
  #define TOUCH_MI_DEPLOY_XPOS -3  // For a magnet on the right side of the bed
  #define TOUCH_MI_DEPLOY_YPOS 190
  #define TOUCH_MI_DEPLOY_YPOS_END 130
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30.825, -1.1, -3.6 }
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 Z20 F1200\nG90\nG1 Y30 X-3\nG1 Y95\nG91\nG1 X15\nG28 XY"
